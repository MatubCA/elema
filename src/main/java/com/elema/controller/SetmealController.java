...
public class SetmealController {
    ...
    @PostMapping
    public Results<String> save(@RequestBody SetmealDto setmealDto){

        setmealService.saveWithDish(setmealDto);

        return Results.success("新增套餐成功");
    }
     ...
     */
    @DeleteMapping
    public Results<String> delete(@RequestParam List<Long> ids){
        setmealService.removeWithDish(ids);
        return Results.success("套餐数据删除成功");
    }
