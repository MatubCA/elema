...
public class DishController {
     ...
     */
    @PostMapping
    public Results<String> save(@RequestBody DishDto dishDto){
        dishService.saveWithFlavor(dishDto);

        return Results.success("新增菜品成功");
    }


    @GetMapping("/{id}")
    public Results<Dish> dishOne(@PathVariable Long id){
        DishDto dishDto = dishService.getByIdWithFlavor(id);
        return Results.success(dishDto);
    }

    @PutMapping
    public Results<String> update(@RequestBody DishDto dto){
